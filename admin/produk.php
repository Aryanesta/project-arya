          ...
          <div id="produk" class="carousel slide container w-75 mb-5" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" id="gambar">
              <div class="carousel-item active">
                  <img src="../upload/product-1.png" alt="Produk 1" class="d-block w-100 h-100 rounded"/>
              </div>
              <?php foreach ($gambar as $slide) : ?>
                  <div class="carousel-item">
                      <img src="../upload/<?=$slide['path']?>" alt="Produk 1" class="d-block w-100 h-100 rounded"/>
                  </div>
                <?php endforeach; ?>
              </div>
